...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/legofy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14840&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/legofy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `legofy` can be installed with:

```
conda install legofy
```

It is possible to list all of the versions of `legofy` available on your platform with:
